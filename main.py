...
# IMPORTING THE MODEL IMAGES INTO A LIST
...
while True:
    ...
    if faceCurFrame:
        ...
        for encodeFace, faceLoc in zip(encodeCurFrame, faceCurFrame):
            matches = face_recognition.compare_faces(encodeListKnown, encodeFace) # true/false value for encoded list after comparision tells which encoding match
